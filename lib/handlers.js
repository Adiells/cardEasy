...
exports.api.cadastro = async(req, res) => {
    ...
    const image = 'default.png' //aparentemente a porra do sql nao tem como alterar uma tabela ja existente colocando o valor default em uma coluna, entao la vamos nós fazer isso igual os íncas e estou com preguiça de recriar a tabela e copiar os dados
        if(row){
